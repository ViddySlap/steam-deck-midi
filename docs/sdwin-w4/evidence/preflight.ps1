...
$expected = '88c1a0b5e1834b44b0993b81c4161c0e82da7625'
...
$record | ConvertTo-Json -Depth 12 | Set-Content -LiteralPath (Join-Path $PSScriptRoot 'preflight.json') -Encoding UTF8
