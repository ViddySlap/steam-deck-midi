...
def main():
    ...
    freed = k32.FreeConsole()
    alloc = k32.AllocConsole()
    result["console"] = {"FreeConsole": freed, "AllocConsole": alloc, "last_error": ctypes.get_last_error()}
    ...
    result["console"]["private"] = bool(alloc) and set(attached) <= set(owned)
