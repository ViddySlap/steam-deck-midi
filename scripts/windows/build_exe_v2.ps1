...
$specPath = Join-Path $RepoRoot "steamdeck-midi-receiver-2.spec"
      ...
      [
        StringTable(
          ...
          [
            ...
            StringStruct(u'FileDescription', u'STEAMDECK MIDI Receiver 2'),
            StringStruct(u'FileVersion', u'$appVersion'),
            StringStruct(u'InternalName', u'STEAMDECK-MIDI-RECEIVER-2'),
            StringStruct(u'OriginalFilename', u'STEAMDECK-MIDI-RECEIVER-2.exe'),
...
$exePath = Join-Path $distDir "STEAMDECK-MIDI-RECEIVER-2.exe"
...
Write-Host ".\dist\STEAMDECK-MIDI-RECEIVER-2.exe --map .\config\windows_midi_map.json --midi-port `"DECK_IN`" --verbose"
